...
class ReadBuffer(object):
    ...
    def read_line(self, sep='\n'):
        ...
        while not self._stream.closed:
            ...
            self._buffer += self._stream.read(self._chunk_size).decode('ascii') # Added this line also 8 Sep 2015 1245
...
class Stream(object):
    ...
    def _run(self):
        ...
        if exception:
            ...
            raise exception # I added exception because it raises an error if exception is not used
